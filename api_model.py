...
#rfc_1 = load('/app/rfc_1.joblib')
#rfc_2 = load('/app/rfc_2.joblib')
...
async def train():
    async with httpx.AsyncClient() as client:
        ...
        try:
            response_contxt = await client.get("http://api_data:8001/data/contxt") 
...
async def train():
    async with httpx.AsyncClient() as client:
        ...
        try:
            response_comp = await client.get("http://api_data:8001/data/comp")  
