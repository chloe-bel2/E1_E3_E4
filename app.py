...
# SQL:
DATABASE_URL = "postgresql://postgres:postgre@host.docker.internal:5432/db_pco" #"postgresql://postgres:postgre@db:5432/db_pco" #"postgresql://postgres:postgre@db/db_pco"
...
# model_embed = SentenceTransformer('./st_javaness')
#model_path = os.path.join(os.getcwd(), 'st_javaness')
#model_path = '/app/st_javaness' 
#model_embed = SentenceTransformer(model_path)
...
def register():
    if request.method == 'POST':
        ...
        try:
            response = requests.post("http://api_data:8001/users", json=user_data)
...
def index():
    ...
    if request.method == 'POST':
        ...
        url = 'http://api_model:8000/predict'
    ...
    if num_runs % 2 != 0 :
        ...
        if stable_algo_1:
            ...
            if not stable_algo_2:
                ...
                '''response_algo_2 = asyncio.run(send_train_request('http://api_model:8000/train_algo_2'))
        ...
        if not stable_algo_1:
            ...
            #response_algo_1 = asyncio.run(send_train_request('http://api_model:8000/train_algo_1'))
